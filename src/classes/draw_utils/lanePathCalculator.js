...
const LANE_PATHS_CONFIG = {
  ...
  // 🔧 修正Lane 2: 從-200起始（參考Lane 1, 4的貝茲曲線方式，保持y軸=560）
  eastLane2Straight:
    'M-200,560C-100,560,100,560,300,560,600,560,900,560,1400,560',
  // 🔧 修正Lane 3: 從-200起始（參考Lane 1, 4的貝茲曲線方式，保持y軸=599）
  eastLane3Straight:
    'M-200,599C-100,599,100,599,300,599,600,599,900,599,1400,599',
  eastLane4Straight:
    'M-330.922,652.46C-242.9248,652.46,-138.468,648.969,-7.878,648.162,188.005,646.95,419.9426,648.2768,561.332,648.473,561.161,806.3,558.73,1183.275,557.224,1299.044',
  westLane1Straight:
