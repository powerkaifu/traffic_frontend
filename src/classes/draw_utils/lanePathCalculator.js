...
const LANE_PATHS_CONFIG = {
  ...
  // 🔧 修正Lane 2: 從-200起始（參考Lane 1, 4的貝茲曲線方式）
  eastLane2Straight:
    'M-200,570C-100,570,100,570,300,570,600,570,900,570,1400,570',
  // 🔧 修正Lane 3: 從-200起始（參考Lane 1, 4的貝茲曲線方式）
  eastLane3Straight:
    'M-200,540C-100,540,100,540,300,540,600,540,900,540,1400,540',
  eastLane4Straight:
